...
class Bot {
	constructor() {
		...
		wqt(inputStr){
			...
			let keySheet = ['開始', '女孩，青春，可愛，活潑', '和諧，平衡', '統一，理想，和平', '愛情，喜歡', '命運，血脈聯繫', '精力充沛，強壯，魅力', '神奇的，穩定性，睡眠', '幼稚，神秘', '自由前往各地，搬運，推動', '原罪', '無意識', '心中的怪物', '正義，審判', '完整性', '美麗，才華', '戰鬥，武器', '突發事件', '破壞性的衝擊，膽量，秩序', '未知事物', '誕生，流動', '自由，飛行', '純潔，純正，魔法', '時間，移動，流暢的', '財富', '開闊處', '審判，挑戰', '遊蕩', '渾沌，愉悅'];
			let positiveSheet = ['起始，新的旅程，希望', '可愛，青春洋溢，新鮮，被保護的', '和諧，平衡的', '理想，和平，統治，有好頭領的群體，父親', '美好的愛情，良好的人際關係', '勤奮，信守承諾，血親，家族親緣', '青春，力量，幸運，受歡迎，有影響力', '穩定，安全感，神秘，安眠', '純潔，可愛，真誠', '彈性，可以和任何人成為朋友，優秀的顧問', '毒藥，侮辱，復仇，惡意，原罪', '財富，意外的幸運，靈感', '惡夢，慾望，忌妒，誘惑，心靈的弱點', '正義，公平，走在正確的道路上，羅盤方位點', '完整，巔峰，絕世之美', '美麗，優秀', '英勇，善戰，天賦，技能', '煩惱，渾沌，失去財產', '勇氣，嘗試與錯誤，男子氣概', '廣闊，無限可能，冒險的', '母親，母性，新生命誕生，和平', '飛行，自由，開闊處，獨立行動', '真誠，純潔，未參雜的，謎團', '人生經歷，重逢，記憶，改變，成長', '富有，豐裕，生意', '驚險，消遣，寧靜', '可靠的，勝利，領導，保護', '諸多相遇，千變萬化，常保如新', '笑聲，愉悅，節慶，脫穎而出，超出常識'];
			let negativeSheet = ['無法預見未來，焦慮', '自私，野蠻，被困在塔中', '無法適應變化，重複', '絕境，枷鎖，暴政', '因愛情而迷失，不分青紅皂白，人際矛盾，利用他人感情', '宿命、懲罰、先祖的罪業、親族關係的束縛', '負起一切責任，牽扯他人，不良的影響', '懶惰，依賴他人的好意，忘恩負義', '無知，輕佻的行動，不瞻前顧後', '孤獨時無助，八面玲瓏，自私', '解藥，贖罪，淨化，原諒', '無意識的罪，意圖良善但依賴於他人', '從噩夢中醒來，恍然大悟，誤解', '偽善，適應性，優柔寡斷，必要之惡，輕率', '理性崩壞（化為野獸），自巔峰跌落', '狂妄，虛榮', '暴力、以力服人、豬突猛進', '從零開始，改變方向，雨過天晴', '渾沌，暴力，不穩定，此路不通', '沒有結論，扯淡', '依賴的，過度照顧，無法應對改變', '孤立、不安、無處落腳、孤獨、被丟下', '傲慢，無用的', '死亡，老化，衰敗，被埋葬，被困在黑暗中', '貪婪，吝嗇', '邪惡，無事生非，虛無', '敗北，不可靠，未能保護', '迷失，無計劃，不安', '沒有剎車，紊亂，惡作劇，無解決方案'];
